  ...
  const features = [
    {
      ...
      description: "State-of-the-art machine learning models for accurate uniform authentication.",
      icon: (
    ...
    },
    {
      ...
      description: "Get instant results with detailed analysis and confidence scores.",
      icon: (
        <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path
            strokeLinecap="round"
